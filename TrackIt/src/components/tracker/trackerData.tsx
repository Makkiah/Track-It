...
export const thisMonth = {
    ...
    "To-Do": ["Day 3 Learning", "Checkout Make.com, Checklist.design, and webaim.org", "Update images to .webp over .png", "Setup Supabase backend for Signature Moment", "Finish book 'Melanin: The Chemical To Black Greatness'", "Add this project to Makkiah.com", "Add 'yearly goals' area at the top that never changes", "Edit Vlog" ]
}
