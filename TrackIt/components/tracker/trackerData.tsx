...
export const habits = {
    ...
    Coding: ["Coded for 6 minutes", "Coded for 1 hour", "Coded for 30 minutes", "Coded for 10 minutes (03/29/26)", "Day 2 of learning / 60 Minutes of Coding", "Add a timestamp for 'last updated'"], 
